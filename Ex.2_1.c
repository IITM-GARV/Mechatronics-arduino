// Use the switch 7 to rotate the servo in clockwise direction and switch 8 for counter-clockwise direction from initial position of servo (90 deg). Every single switch press and release event should correspond to 1 degree rotation. 
